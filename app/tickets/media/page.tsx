...
export default function MediaTicketPage() {
    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-6">
      <div className="w-full max-w-xl">
        ...
        <p className="text-gray-400 text-center mb-10">
          Apply for Super 24 media credentials.
        </p>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 transition rounded-xl py-4 font-semibold"
            >
              {loading ? "SUBMITTING..." : "APPLY FOR MEDIA ACCESS"}
            </button>
          </form>
        )}
      </div>
