...
A coach’s guard. Low-risk, high-trust PG who affects winning in ways the box score won’t always show.`,
  ...
  {
    id: "zytravius-wille-2026",
    name: "Zytravius Willie",
    height: "6'2",
    position: "G",
    classYear: "2026",
    school: "Marshall HS",
    state: "TX",
    stars: 1,
    summary: `Good-sized guard with plenty of room to grow. Steady, confident, and reliable — Willie doesn’t jump off the screen, but he consistently does whatever the game calls for. Can shoot, pass, score, and willingly accept defensive assignments. Long arms paired with solid athleticism give him versatility on both ends. With a strong foundation and feel for the game, Hill profiles as a low-maintenance, high-trust guard whose value shows up in winning plays. Not flashy, but effective.`,
  },
  {
