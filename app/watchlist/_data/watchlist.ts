...
summary: "MJ Ward is a dog. He plays with a chip on his shoulder and wears his underrated status like fuel. Every possession is personal, and his killer mentality shows in the biggest moments. The game never speeds him up, and he carries himself with a pro's poise well beyond his years. Offensively, Ward is one of the most skilled guards in the region. An elite ballhandler with exceptional pace and space creation, he consistently puts defenders in compromising positions. True three-level scorer who finishes with either hand through traffic, around shot blockers, and from impossible angles. His jumper is automatic, connecting on 55% from three with legitimate deep range that forces defenses to pick him up well beyond the arc. He's also a very good passer who reads the floor naturally and consistently makes the right play. Defensively, Ward competes. He's willing to take on the toughest assignments and has all the tools to become a true lockdown defender. His quick feet, elite change of speed, and relentless motor impact both ends of the floor, allowing him to create separation offensively while staying attached to ball handlers and becoming a real pest defensively when locked in. 
At the 2026 NCP Super 24 Invitational, Ward left no doubt he was on of the best All-Americans in attendence. He made noise in the 3-Point Shootout, 5-Spot, the 1-on-1 Challenge, and carried that same confidence into the game, stamping himself as one of the premier guards in the region. As his frame continues to mature and his athleticism catches up with his skill, his ceiling becomes downright scary.  "
},
...
summary: "Deadeye sniper. The ball barely touches the rim when it leaves his hand. With a high release point and effortless mechanics, Tyeskie has established himself as one of the most dangerous shooters in East Texas. He can heat up in a hurry, punishing defenses with lethal one-dribble pull-ups, shot fakes, jab steps, and timely attacks against hard closeouts. What separates him is that he's far more athletic than people realize. An explosive leaper, Tyeskie won the 2026 NCP Super 24 All-American Dunk Contest, then turned around and dropped 25 points in the game, proving he's much more than just a shooter. A high-IQ guard with excellent shot selection and a low turnover rate, he understands how to impact winning without forcing the action and is fully capable of taking over when he finds his rhythm. Defensively, his long, active arms are a problem. He consistently disrupts ball handlers and bigger wings, generates deflections, and turns defense into offense with his instincts and activity. "
},
...
summary: "Deunte Hamilton is a shifty, confident lead guard who plays with pace, poise, and plenty of swagger. At 5'11", he keeps defenders guessing with his change of speed, tight handle, and ability to create separation on demand. A true three-level scorer, Hamilton is a knockdown shooter who can heat up in a hurry, whether it's off the catch, off the bounce, or pulling up in transition. He finishes through contact, embraces tough shots around the rim, and has the confidence to deliver in big moments. What separates Hamilton is his feel for the game. He sees the floor well, reads defenses on the fly, and consistently makes the right play without slowing the offense down. He controls tempo, keeps teammates involved, and understands when to score versus when to facilitate. Defensively, he's more than capable when locked in, using active hands, anticipation, and relentless effort to pressure opposing guards and create turnovers. Hamilton's combination of shot creation, playmaking, confidence, and competitive edge gives him the tools to impact winning in multiple ways. As he continues to mature physically, expect his game to keep trending upward. 

At the 2026 NCP Super 24 Invitational, Hamilton turned plenty of heads, proving he could go toe-to-toe with every guard in attendance. He led all scorers with 31 points while putting together strong performances in the individual events, showing his shot-making, confidence, and ability to rise to the occasion. With a prep school stop up next, Hamilton has positioned himself for a breakout campaign and the opportunity to elevate his stock even further. "
},
